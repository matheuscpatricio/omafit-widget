...
function enforceSizeFirstMessage(
  ...
  // Também removemos qualquer frase "Seu tamanho ideal é ..." que o GPT já tenha gerado, para não duplicar.
  const bodyWithoutSizeSentence = removeAllSizeSentences(language, withoutCatalog);
  const body = removeSizeMentions(bodyWithoutSizeSentence, size);
