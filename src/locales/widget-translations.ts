export const widgetTranslations = {
  pt: {
    ...
    tryOnServiceUnavailable: 'O provador está temporariamente indisponível. Tente novamente em instantes.',
    shopperProfileLoading: 'A carregar o seu perfil…',
    shopperProfileDeleteError: 'Não foi possível apagar o perfil. Tente novamente.',
    shopperProfileSaveError: 'Não foi possível guardar o perfil. Tente novamente.',
    shopperRestoreTitle: 'Encontrámos as suas medidas',
    shopperRestoreContinue: 'Continuar com estas medidas',
    shopperRestoreUpdate: 'Atualizar medidas',
    shopperRestoreForget: 'Esquecer perfil',
    shopperSaveConsent: 'Guardar as minhas medidas neste dispositivo para a próxima visita',
    shopperSaveSaved: 'Medidas guardadas',
    shopperSaveDismiss: 'Agora não',
    shopperWhatsAppTitle: 'Receber novidades no WhatsApp',
    shopperWhatsAppPhone: 'Número com DDI',
    shopperWhatsAppConsent: 'Aceito receber mensagens da loja no WhatsApp',
    shopperWhatsAppPhotoConsent: 'A loja pode usar a foto deste provador nas mensagens',
    shopperWhatsAppSubmit: 'Confirmar',
    shopperWhatsAppDismiss: 'Agora não',
    shopperWhatsAppSaved: 'Preferência guardada',
    shopperWhatsAppError: 'Não foi possível guardar o WhatsApp. Tente novamente.',
    shopperWhatsAppEncryptionError: 'A loja ainda não configurou a proteção dos dados. Tente mais tarde.',
    shopperWhatsAppRevoke: 'Deixar de receber WhatsApp',
  },
  es: {
    // Loading
    ...
    tryOnServiceUnavailable: 'El probador no está disponible en este momento. Inténtalo de nuevo en unos instantes.',
    shopperProfileLoading: 'Cargando tu perfil…',
    shopperProfileDeleteError: 'No se pudo borrar el perfil. Inténtalo de nuevo.',
    shopperProfileSaveError: 'No se pudo guardar el perfil. Inténtalo de nuevo.',
    shopperRestoreTitle: 'Encontramos tus medidas',
    shopperRestoreContinue: 'Continuar con estas medidas',
    shopperRestoreUpdate: 'Actualizar medidas',
    shopperRestoreForget: 'Olvidar perfil',
    shopperSaveConsent: 'Guardar mis medidas en este dispositivo para la próxima visita',
    shopperSaveSaved: 'Medidas guardadas',
    shopperSaveDismiss: 'Ahora no',
    shopperWhatsAppTitle: 'Recibir novedades por WhatsApp',
    shopperWhatsAppPhone: 'Número con prefijo',
    shopperWhatsAppConsent: 'Acepto recibir mensajes de la tienda por WhatsApp',
    shopperWhatsAppPhotoConsent: 'La tienda puede usar la foto de este probador en los mensajes',
    shopperWhatsAppSubmit: 'Confirmar',
    shopperWhatsAppDismiss: 'Ahora no',
    shopperWhatsAppSaved: 'Preferencia guardada',
    shopperWhatsAppError: 'No se pudo guardar el WhatsApp. Inténtalo de nuevo.',
    shopperWhatsAppEncryptionError: 'La tienda aún no configuró la protección de datos. Inténtalo más tarde.',
    shopperWhatsAppRevoke: 'Dejar de recibir WhatsApp',
  },
  en: {
    // Loading
    ...
    tryOnServiceUnavailable: 'The try-on service is temporarily unavailable. Please try again in a moment.',
    shopperProfileLoading: 'Loading your profile…',
    shopperProfileDeleteError: 'Could not delete the profile. Please try again.',
    shopperProfileSaveError: 'Could not save the profile. Please try again.',
    shopperRestoreTitle: 'We found your measurements',
    shopperRestoreContinue: 'Continue with these measurements',
    shopperRestoreUpdate: 'Update measurements',
    shopperRestoreForget: 'Forget profile',
    shopperSaveConsent: 'Save my measurements on this device for the next visit',
    shopperSaveSaved: 'Measurements saved',
    shopperSaveDismiss: 'Not now',
    shopperWhatsAppTitle: 'Get updates on WhatsApp',
    shopperWhatsAppPhone: 'Number with country code',
    shopperWhatsAppConsent: 'I agree to receive store messages on WhatsApp',
    shopperWhatsAppPhotoConsent: 'The store may use this try-on photo in messages',
    shopperWhatsAppSubmit: 'Confirm',
    shopperWhatsAppDismiss: 'Not now',
    shopperWhatsAppSaved: 'Preference saved',
    shopperWhatsAppError: 'Could not save WhatsApp. Please try again.',
    shopperWhatsAppEncryptionError: 'This store has not configured data protection yet. Try again later.',
    shopperWhatsAppRevoke: 'Stop WhatsApp messages',
  },
};
