        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
          <div className="flex items-center justify-between h-16">
            <a href="#top" className="flex items-center gap-2 group">
              <span
                className="font-bungee text-[22px] tracking-tight text-ink-800 transition-colors"
            ...
            <nav className="hidden md:flex items-center gap-1">
              {links.map((l) => (
                <a
                  key={l.href}
                  href={l.href}
                  className="px-3.5 py-2 text-sm font-medium rounded-xl text-ink-600 transition-all hover:bg-ink-50 hover:text-ink-800"
                >
                  {l.label}
                </a>
              ))}
            ...
            <button
              ...
              className="md:hidden grid h-10 w-10 place-items-center rounded-xl text-ink-800 transition-colors hover:bg-ink-50"
